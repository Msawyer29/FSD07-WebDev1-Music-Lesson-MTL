<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-600">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/musiclessonmtl_logo.jpg') }}" alt="Music Lesson MTL Logo" class="block" style="height: 64px; width: auto;" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!-- Teachers Do Not See 'Book Lesson' or (Student) 'Lesson Manager'view -->
